    ...
    <nav className="bg-white border-gray-200 dark:bg-[#023047]">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        ...
        >
          ...
          <ul className=" flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-[#FFB703] md:dark:bg-[#023047] dark:border-gray-700">
            <li>
              <Link
                href="/"
